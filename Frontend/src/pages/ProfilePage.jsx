                ...
                <div className="flex items-center gap-6">
                    <div className="relative group">
                        <img 
                            ...
                            alt="Profile"
                            className="h-48 w-48 rounded-full shadow-2xl object-cover"
                        />
                        <button
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                        {playlists.map(playlist => (
                            <div 
                                ...
                                className="group relative flex cursor-pointer flex-col items-center rounded-md bg-[#181818] p-4 hover:bg-[#282828] transition-colors duration-300"
                            >
                                ...
                                <div className="w-full">
                                    <h3 className="mb-2 truncate text-base font-bold">{playlist.name}</h3>
                                    <p className="truncate text-sm text-[#b3b3b3]">
                                        {playlist.type === 'artist' ? 'Artist' : 
            ...
            <div className="w-[500px] rounded-lg bg-[#282828] p-6">
                ...
                <div className="mb-6 flex gap-4">
                    <div className="relative h-48 w-48">
                        <img
                            src={editForm.avatar ? URL.createObjectURL(editForm.avatar) : userData?.avatar || assets.avatar}
                            alt="Profile"
